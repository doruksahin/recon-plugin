...
- Add the quote-grep pass to `verify-triage.sh`
  ([validate-triage-yaml](../../0.14.0/validate-triage-yaml/README.md)); normalize whitespace
...
- Depends mildly on [validate-triage-yaml](../../0.14.0/validate-triage-yaml/README.md)
