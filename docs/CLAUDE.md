...
| `system-map.html` | Generated maintainer map of the shipped runtime, repository-only replay laboratory, and improvement loop. Owned by `tools/render-system-map.py`; source links, hashes, current improvement state, and bytes are drift-checked. |
