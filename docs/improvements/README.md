...
| [ticket-ledger](ticket-ledger/README.md) | proposed | P2 | Append-only *history.ndjson* survives step 0; a rail logs each transition; nothing may read it as evidence |
...
| [state-canvas-skill](state-canvas-skill/README.md) | proposed | P2 | New skill renders a node-canvas artifact per ticket; state derived from file presence, one stable URL |
