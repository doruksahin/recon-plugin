...
| `hosts.md` | Executable local-host contract for Claude Code and Codex: detection, preflight, canonical actions, invocation rendering, capability levels, and explicit hosted-runtime exclusion. |
