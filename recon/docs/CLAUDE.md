...
| `storage.md` | Optional task-packet-store delivery contract: literal current-workspace command, exact package pin, result/failure schema, environment-only credentials, and deterministic filesystem/Drive acceptance recipes. |
